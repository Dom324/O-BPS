...
namespace bt9 {
    ...
    namespace BrBehavior
    {
        ...
        enum class Indirectness : uint8_t
        {
            UNKNOWN,
    ...
    namespace BrClass{
        ...
        enum class Conditionality : uint8_t
        {
            UNKNOWN,
    ...
    struct BrClass_BrBehavior{
        BrClass::Type               type            : 2;
        BrClass::Directness         directness      : 2;
        BrClass::Conditionality     conditionality  : 2;

        BrBehavior::Direction       direction       : 3;
        BrBehavior::Indirectness    indirectness    : 2;
    ...
    /*!
     * \brief Overloaded output operator for BrClass_BrBehavior class
     */
    inline std::ostream & operator<<(std::ostream & os, const BrClass_BrBehavior & br_class_br_behavior) 
    {
        os << "class: ";
    
        os << std::setw(4) << br_class_br_behavior.type << "+" 
           << br_class_br_behavior.directness << "+" 
           << br_class_br_behavior.conditionality;

        os << "behavior: " << std::setw(4) << br_class_br_behavior.direction << "+" << br_class_br_behavior.indirectness;
    ...
    public:
        ...
        BasicNodeRecord(
                        ...
                        BrClass_BrBehavior br_class_br_behavior,
                        uint8_t opcode_size,
            ...
            br_class_br_behavior_(br_class_br_behavior),
        ...
        BrClass_BrBehavior brClass_brBehavior() const { return br_class_br_behavior_; }
        ...
        bool brClassTypeIs(const std::string type_str) const {
            return (StrEnumMap<BrClass::Type>::convertEnumToStr(br_class_br_behavior_.type) == type_str);
        }
        ...
        bool brClassDirectnessIs(const std::string type_str) const {
            return (StrEnumMap<BrClass::Directness>::convertEnumToStr(br_class_br_behavior_.directness) == type_str);
        }
        ...
        bool brClassConditionalityIs(const std::string type_str) const {
            return (StrEnumMap<BrClass::Conditionality>::convertEnumToStr(br_class_br_behavior_.conditionality) == type_str);
        }
        ...
        bool brBehaviorDirectionIs(const std::string type_str) const {
            return (StrEnumMap<BrBehavior::Direction>::convertEnumToStr(br_class_br_behavior_.direction) == type_str);
        }
        ...
        bool brBehaviorIndirectnessIs(const std::string type_str) const {
            return (StrEnumMap<BrBehavior::Indirectness>::convertEnumToStr(br_class_br_behavior_.indirectness) == type_str);
        }
        ...
        virtual void printOptionalFields(std::ostream & os) const
        {
            ...
            os << br_class_br_behavior_ << std::setw(2) << " "
    ...
    protected:
        ...
        // Dynamically observed branch target counts for this branch
        uint32_t br_tgt_cnt_ = 0;

        // Pre-defined Key-Value Pairs
        uint32_t br_taken_cnt_ = 0;
        uint32_t br_untaken_cnt_ = 0;
        BrClass_BrBehavior br_class_br_behavior_ = {
            .type =             BrClass::Type::UNKNOWN,
            .directness =       BrClass::Directness::UNKNOWN,
            .conditionality =   BrClass::Conditionality::UNKNOWN,
            .direction =        BrBehavior::Direction::UNKNOWN,
            .indirectness =     BrBehavior::Indirectness::UNKNOWN
        };
    ...
    public:
        ...
        BasicEdgeRecord(uint64_t observed_traverse_cnt,
...
namespace bt9 {
     ...
     */
    void BrClass_BrBehavior::parseBrBehavior(const std::string & str)
    {
     ...
     * in the BT9 tracefile
     */
    void BrClass_BrBehavior::parseBrClass(const std::string & str)
    {
        std::string token = str;
        std::replace(token.begin(), token.end(), '+', ' ');
        std::stringstream ss(token);
